    ...
    return (
        ...
        > 
            ...
            <Grid container  direction={"row"} spacing={1.35}>
                <Grid item>
                    <Typography sx={{ fontSize: 20, fontFamily: 'Futura', textAlign: 'center', color: '#50194d' }} gutterBottom>LOGIN</Typography>
                    <LoginForm />
                    <br />
                    <br />
                    ...
                    <Typography sx={{fontFamily: 'Futura', width: '100%'}} variant="h7" component="h2"></Typography>
                    <Typography sx={{fontFamily: 'Futura', width: '100%'}} variant="h6" component="h2"></Typography>
                ...
                <Grid item>
                    <Typography sx={{ fontSize: 20, fontFamily: 'Futura', textAlign: 'center', color: '#50194d' }} gutterBottom>Register Account</Typography>
                    <Registration />
                </Grid>
            </Grid>
